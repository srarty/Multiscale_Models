...
if ~ESTIMATE
    ...
    for i = 1:NStates
        ...
        plot(1000*t(1:min(length(t),size(x,2))),x(i,1:min(length(t),size(x,2)))');
    ...
    for i = 2:NAugmented - NStates
        ...
        plot(1000*t(1:min(length(t),size(x,2))),x(NStates + i,1:min(length(t),size(x,2)))*nmm.delump(i-1)');
