...
input_spike_rate_thalamic = 2 #1.5 # spikes/ms/cell (spontaneous activity)
input_spike_rate_thalamic_in = 1.5 #1.5 # spikes/ms/cell (spontaneous activity)
...
if SAVE:
    ...
    save_dictionary={'LFP_V': lfp_v,
                    ...
                    'i_ie': mean(Py_monitor.I_exc,0),
                    'i_ii': mean(Py_monitor.I_inh,0),
                    'p_PP': p_PP,
                    'p_II': p_II,
                    'p_IP': p_IP,
                    'p_BP': p_BP,
...
# brunel(u=0, SAVE=False, PLOT=True)
