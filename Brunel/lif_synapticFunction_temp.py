...
# Pyramidal 
# single_exp_weight_P = params_py.get('single_exp_weight')
alpha_simple_weight_AMPA_P = params_py.get('alpha_weight_AMPA')
alpha_simple_weight_GABA_P = params_py.get('alpha_weight_GABA')
# delayed_exp_weight_P = params_py.get('delayed_exp_weight')

# Inhibitory interneurons
# single_exp_weight_I = params_in.get('single_exp_weight')
alpha_simple_weight_AMPA_I = params_in.get('alpha_weight_AMPA')
alpha_simple_weight_GABA_I = params_in.get('alpha_weight_GABA')
# delayed_exp_weight_I = params_in.get('delayed_exp_weight')

# Excitatory interneurons
# single_exp_weight_E = params_ex.get('single_exp_weight')
alpha_simple_weight_AMPA_E = params_ex.get('alpha_weight_AMPA')
alpha_simple_weight_GABA_E = params_ex.get('alpha_weight_GABA')
# delayed_exp_weight_E = params_ex.get('delayed_exp_weight')
