# -*- coding: utf-8 -*-
"""
Created on Mon Apr  4 17:49:18 2022
...
Testing different synaptic functions to get a better fit in the NMM    
"""
...
eqs_py = get_equations('pyramidal')
eqs_in = get_equations('inhibitory')
eqs_ex = get_equations('spiny')
