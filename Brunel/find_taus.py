...
#     monitor = synaptic_functions_exploration(alpha_ii = alpha)
...
for alpha in arange(-335, 0.1, 6.5):
    monitor = synaptic_functions_exploration(alpha_ie = alpha)
...
for alpha in arange(0, 691, 13.53):
    monitor = synaptic_functions_exploration(alpha_ei = alpha)
...
for alpha in arange(0, 891, 35.6):
    monitor = synaptic_functions_exploration(alpha_ee = alpha)
